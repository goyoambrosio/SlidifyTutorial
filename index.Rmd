...
You can view sllidify presentations with any web browser and share them easily
...
- A language and environment for statistical computing and graphics: [R](https://www.r-project.org/)
- An integrated development environment (IDE) for R: [RStudio](https://www.rstudio.com/) or Emacs
- A way to install R packages under development: [devtools](https://github.com/r-lib/devtools)
...
http://slidify.github.io recommends installing the `dev` version of the package
